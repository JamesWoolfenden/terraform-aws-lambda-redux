...
| <a name="input_kms_key_id"></a> [kms_key_id](#input_kms_key_id)                                                 | CMK for Lambda                                                                                            | `string`       | n/a                                      |   yes    |
...
| <a name="input_passrole"></a> [passrole](#input_passrole)                                                       | n/a                                                                                                       | `bool`         | `false`                                  |    no    |
...
| <a name="input_role_arn"></a> [role_arn](#input_role_arn)                                                       | The name you want your IAM role to have                                                                   | `string`       | `""`                                     |    no    |
...
| <a name="output_memory_size"></a> [memory_size](#output_memory_size)                | n/a         |
| <a name="output_source_code_size"></a> [source_code_size](#output_source_code_size) | n/a         |
